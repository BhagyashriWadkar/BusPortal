...
public class ExceptionController {
	 ...
	 @ExceptionHandler(value =PassTypeException.class)
	   public ResponseEntity<Object> exception(PassTypeException exception) {
	      return new ResponseEntity<>("Invalid passType", HttpStatus.NOT_FOUND);
	 }
